...
def analyze_text(filename):
    ...
    Args:
        filename: The name of the file to analyze.abs

    Raises:
        IOError: If ''filename'' does not exists or can't be read.abs
...
class TextAnalysisTests(unittest.TestCase):
    ...
    def tearDown(self):
        """Fixture that deletes the file userd bt the test methods."""
        try:
